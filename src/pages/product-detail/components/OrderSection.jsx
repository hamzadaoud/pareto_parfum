...
const OrderSection = ({ product, onAddToCart }) => {
...
<button
key={size}
className={p-3 rounded-lg border-2 transition-all duration-200 ${   index === 1    ? 'border-accent bg-accent/10 text-accent' :'border-border hover:border-accent/50 text-muted-foreground'   }}
>
